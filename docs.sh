...
mkdir -p docs/bootstrap4 && ./node_modules/.bin/ng build --base-href=$BASE_HREFbootstrap4/ --deploy-url=$BASE_HREFbootstrap4/ && cp -R dist/ngx-tru-forms-app/* docs/bootstrap4
