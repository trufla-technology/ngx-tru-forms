...
TruUiComponent.ɵfac = function TruUiComponent_Factory(t) { return new (t || TruUiComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_services_schema_listener_service__WEBPACK_IMPORTED_MODULE_1__.SchemaListenerService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](src_app_services_data_listener_service__WEBPACK_IMPORTED_MODULE_2__.DataListenerService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdirectiveInject"](_json_schema_examples_json_schema_examples_samples__WEBPACK_IMPORTED_MODULE_3__.JsonSchemaExamplesSamples)); };
TruUiComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: TruUiComponent, selectors: [["app-tru-ui"]], viewQuery: function TruUiComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function TruUiComponent_Template_select_change_4_listener($event) { return ctx.changeLanguage($event.target.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function TruUiComponent_Template_select_change_12_listener($event) { return ctx.toggleViewonly($event.target.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function TruUiComponent_Template_select_change_22_listener($event) { return ctx.toggleData($event.target.value); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("handleSubmit", function TruUiComponent_Template_jf_form_handleSubmit_29_listener($event) { return ctx.handleSubmit($event); })("handleCancel", function TruUiComponent_Template_jf_form_handleCancel_29_listener($event) { return ctx.handleCancel($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    } if (rf & 2) {
