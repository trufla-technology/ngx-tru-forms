...
/* harmony import */ var ngx_bootstrap_typeahead__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ngx-bootstrap/typeahead */ "./node_modules/ngx-bootstrap/typeahead/fesm2015/ngx-bootstrap-typeahead.js");
...
class CommonComponent {
     ...
     * @param {?=} imageCompress
     */
    constructor(sanitizer, cd, localeService, validationFeedbackTranslation, imageCompress) {
...
class DateViewComponent extends CommonComponent {
    constructor() {
        super(...arguments);
        this.numberMask = text_mask_addons_dist_createNumberMask__WEBPACK_IMPORTED_MODULE_11___default()({ allowDecimal: false, prefix: '' });
    }
    /**
     * @param {?} value
     * @return {?}
...
class TruUiPhotoComponent extends CommonComponent {
     ...
     */
    handleDrop(files) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_24__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    processFile(files) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_24__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            /** @type {?} */
            const file = yield this.toBase64(files[0]);
            /** @type {?} */
            ...
            if ((this.schema.maxSize && +this.schema.maxSize < +files[0].size / 1024 / 1024) ||
                ...
                if (['png', 'jpeg', 'jpg', 'jpeg', 'gif'].indexOf(ext.toLowerCase()) !== -1) {
                    this.compressFile(file.toString()).then((/**
                     * @param {?} res
                     * @return {?}
                     */
                    (res) => {
