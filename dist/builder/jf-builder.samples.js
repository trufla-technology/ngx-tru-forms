...
var JfBuilderSamples = /** @class */ (function () {
    function JfBuilderSamples() {
        this.json = {
            add_vehicle: {
                title: 'Add Vehicle',
    ...
    JfBuilderSamples.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    JfBuilderSamples.ctorParameters = function () { return []; };
    return JfBuilderSamples;
}());
export { JfBuilderSamples };
