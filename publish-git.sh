...
sed -i '' 's/forRoot(.*),/forRoot(JsonFormMaterialModule),/' src/index.html
sed -i '' 's/<!-- bootstrap4-cdn -->/<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">/' src/app/json-schema-examples/json-schema-examples.module.ts
